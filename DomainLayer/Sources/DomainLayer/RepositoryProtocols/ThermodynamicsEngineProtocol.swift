//
//  ThermodynamicsEngineProtocol.swift
//  DomainLayer
//
...
/// Domain : Protocol : defines the contract for thermodynamic calculations
public protocol ThermodynamicsEngineProtocol: Sendable {
